...
# LOAD DATA
data = pd.read_csv("data/dataset_exported 2.csv", index_col='Unnamed: 0')  
...
train_set = pd.read_csv('data/application_train.csv',nrows = 10000)
...
model1 = joblib.load("models/classifier_rf_model.pkl",)
# Load the surrogate model
surrogate_model = joblib.load("models/preprocessor.pkl")
